    ...
    >
      ...
      <div ref={ref} className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          {/* HOVER ANIMATED TITLE - Optimized for Safari */}
          <h2 className="group inline-block font-display text-4xl md:text-6xl font-black mb-16 cursor-default">
            <span className="inline-block transition-transform duration-500 ease-out group-hover:translate-x-2 will-change-transform">
              About Me
            </span>
            <span className="inline-block ml-1 transition-all duration-500 ease-out group-hover:-translate-y-2 group-hover:text-terminal-green will-change-transform text-muted-foreground">
              .
            </span>
          </h2>
        </div>
