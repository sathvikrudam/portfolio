      ...
      <div ref={ref} className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm md:text-base leading-relaxed mb-12 max-w-xl mx-auto">
            Actively looking for opportunities to contribute as a Java developer
            and software engineer where I can apply my programming skills,
        ...
        >
          {roles.map((role, i) => (
            <div
              key={role.title}
              className="group bg-card border border-border rounded-2xl p-5 text-center
